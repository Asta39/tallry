...
const notes: Record<string, string> = {
  ...
  items: "# type: service | goods | unproduced. group: item group name (created automatically if missing; required when the org enforces item groups, except for unproduced). vat_class: B16 (16%) | C0 (zero-rated) | A_EXEMPT | D_NONVAT. track_stock: yes | no. Prices in KSh. opening_qty: starting stock on hand, valued at buying_cost (only used when track_stock is yes).",
