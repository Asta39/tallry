      ...
      <div className="bg-white rounded-2xl border border-[var(--color-ink-200)] p-6 sm:p-8 shadow-xs">
        <form action={createEmployeeAction} className="space-y-6">
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-[var(--color-ink-100)]">
            ...
            <button
              type="submit"
              className="px-5 py-2.5 text-xs font-semibold text-white bg-[var(--color-accent-600)] hover:bg-[var(--color-accent-700)] rounded-lg transition-colors shadow-xs cursor-pointer"
            >
