...
export default function GlobalError({
  ...
  return (
    <html>
      <body className="min-h-screen bg-[#f8fafc] flex flex-col items-center justify-center text-center px-4 py-12 font-sans">
        ...
        <p className="text-xs text-gray-500 max-w-sm mt-1 mb-6">
          The system encountered a temporary error during reload. Please refresh to continue.
        </p>
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="px-4 py-2 rounded-lg border border-gray-300 hover:bg-gray-50 text-gray-700 text-xs font-medium transition-colors"
          >
            Reload page
          </button>
        </div>
