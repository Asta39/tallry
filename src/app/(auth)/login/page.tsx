          ...
          <label className="block">
            ...
            <div className="relative mt-1">
              <input
                ...
                placeholder="••••••••"
              />
              <Tooltip text={showPassword ? "Hide password" : "Show password"} side="left" className="absolute right-3 top-1/2 -translate-y-1/2">
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="text-[var(--color-ink-400)] hover:text-[var(--color-ink-600)] transition-colors"
