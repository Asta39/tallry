...
ALTER TABLE contacts ADD COLUMN IF NOT EXISTS whatsapp_consent BOOLEAN NOT NULL DEFAULT TRUE;
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_whatsapp_configs_org ON whatsapp_configs(org_id);
...
CREATE INDEX IF NOT EXISTS idx_whatsapp_templates_org_key ON whatsapp_templates(org_id, key);
...
CREATE INDEX IF NOT EXISTS idx_whatsapp_groups_org ON whatsapp_groups(org_id, group_id);
...
CREATE INDEX IF NOT EXISTS idx_whatsapp_rules_org_event ON whatsapp_rules(org_id, event_type);
...
CREATE INDEX IF NOT EXISTS idx_whatsapp_logs_org_sent ON whatsapp_logs(org_id, sent_at);
