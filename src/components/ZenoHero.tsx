  ...
  return (
    <div data-zeno-hero style={{ width: "100%", fontFamily: SYSTEM_FONT }}>
      <style>{`
        ...
        [data-zeno-hero] [data-gp-enter]{position:absolute;width:1px;height:1px;overflow:hidden;clip-path:inset(50%);white-space:nowrap;}
        [data-zeno-hero] [data-gp-enter]:focus-visible{position:static;width:auto;height:auto;overflow:visible;clip-path:none;white-space:normal;min-height:46px;padding:0 20px;gap:24px;background:#0f766e;border:1px solid #0c5951;border-radius:10px;color:#fff;font-size:13px;font-weight:600;display:inline-flex;align-items:center;outline:2px solid #0f766e;outline-offset:4px;}
        ...
        [data-zeno-header]{position:absolute;inset:clamp(12px,2.5cqw,24px) clamp(20px,5cqw,56px) auto;display:flex;align-items:flex-start;justify-content:space-between;gap:16px;}
        [data-zeno-logo]{display:block;height:96px;width:auto;object-fit:contain;margin-top:-6px;}
        [data-zeno-tag]{font-size:11.5px;line-height:1.5;color:#75757c;text-align:right;padding-top:8px;}
      ...
      <GlyphPortal
        ...
        style={{ "--gp-field": "#0b332f", "--gp-paper": "#fefefe", "--gp-ink": "#181818", "--gp-foreground": "#fbfbfa" }}
        front={
          <>
            <div data-zeno-header>
              <img data-zeno-logo src="/admin-logo.jpg" alt="Zeno" />
              <div data-zeno-tag>Accounting built for Kenyan businesses</div>
            </div>
            <p data-zeno-eyebrow>Invoicing · Payroll · Reports · Reconciliation</p>
