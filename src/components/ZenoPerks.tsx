...
const PERKS = [
  {
    title: "One product, not three apps stitched together",
  ...
  {
    title: "Simple KES pricing, not a tiered USD subscription",
  ...
  return (
    <div className="w-full bg-white" ref={perksRef}>
      <div className="max-w-4xl mx-auto px-4 py-20 sm:py-24">
        ...
        <TimelineContent as="div" animationNum={5} timelineRef={perksRef} customVariants={revealVariants} className="mt-14 text-center">
          <Link
            href="/vs/zoho-books"
          ...
          >
            See how Zeno compares to Zoho Books →
          </Link>
        </TimelineContent>
      </div>
    </div>
