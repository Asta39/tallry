  ...
  return (
    <Document title={`${doc.number} — ${org.name}`}>
      <Page size="A4" style={s.page}>
        {/* Backgrounds */}
        {template === "beige" && <View style={{ position: "absolute", top: -42, left: -42, bottom: -140, right: -42, backgroundColor: "#faf9f5", zIndex: -1 }} />}
        {template === "pastel" && <View style={{ position: "absolute", top: -42, left: -42, bottom: -140, right: -42, backgroundColor: org.brandColor || "#0f766e", opacity: 0.05, zIndex: -1 }} />}
